 ...
 *  
 *  Edited by Irene Vigue Guix (05/04/2016).
 *  Motor Imagery vs Motor Execution version.
 *
...
// MOTOR IMAGERY VS MOTOR EXECUTION KEYS
      case 'f':
         OBCI.auxData[2] = 1;
         if(!is_running){
         Serial0.println("I got f");
         }
         break;
      case 'g':
         OBCI.auxData[2] = 2;
         if(!is_running){
         Serial0.println("I got g");
         }
         break;
      case 'k':
         OBCI.auxData[2] = 3;
         if(!is_running){
         Serial0.println("I got k");
         }
         break;
      case 'l':
         OBCI.auxData[2] = 4;
         if(!is_running){
         Serial0.println("I got l");
         }
         break;
