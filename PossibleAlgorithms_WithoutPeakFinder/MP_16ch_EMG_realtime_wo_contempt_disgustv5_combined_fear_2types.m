...
min = load('min_wo_contempt_2fear_disgustv4.txt');
max = load('max_wo_contempt_2fear_disgustv4.txt');
avg = load('avg_wo_contempt_2fear_disgustv4.txt');

% Ratio of data points in range to total difference between data points and averages
N = abs(M/(sum(M)));
N2 = [N;N;N;N;N;N;N;N;N];
diff = abs(N2 - avg);
...
% Condense emotion-types and calculate percentages
S4 = [S3;S3;S3;S3;S3;S3;S3;S3;S3];
percentage = (ratio./S4)*100;
percentage2 = percentage';
disgust2 = (percentage2(1,3))*.50735 + (percentage2(1,4))*.125 + (percentage2(1,9))*.36765;  % Uses frequency of each type
percentage2(1,3) = disgust2;
percentage2(1,4:8) = percentage2(1,5:9);
percentage2(:,8:9) = [];
fear2 = (percentage2(1,2) + percentage2(1,7))/2;
percentage2(:,7) = [];
percentage3 = (percentage2/sum(percentage2))*100;
%HAVE 1sad 2fear1 3dis1 4dis2 5ang 6sur 7hap 8fear2 9dis3
%1sad 2fear1 3dis12 4ang 5sur 6hap 7fear2
%1sad 2fear12 3dis12 4ang 5sur 6hap

%WANT 1sad 2fear1 3dis1 4dis2 5ang 6sur 7hap 8fear2 9dis3
%1sad 2fear1 3dis123 4ang 5sur 6hap 7fear2
%1sad 2fear12 3dis12 4ang 5sur 6hap
