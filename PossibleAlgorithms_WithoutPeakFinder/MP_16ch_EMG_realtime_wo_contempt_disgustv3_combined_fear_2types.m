...
% Most accurate for disgust (more than v1,v2,v4,v5)
...
min = load('min_wo_contempt_2fear_disgustv3.txt');
max = load('max_wo_contempt_2fear_disgustv3.txt');
avg = load('avg_wo_contempt_2fear_disgustv3.txt');
...
disgust2 = (percentage2(1,3) + percentage2(1,4))/2;
